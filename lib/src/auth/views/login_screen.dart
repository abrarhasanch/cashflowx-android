            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.account_balance_wallet_outlined, size: 40, color: Colors.white),
                ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: Image.network(
                      ...
                      height: 20,
                      width: 20,
                      errorBuilder: (_, __, ___) => const Icon(Icons.g_mobiledata_rounded, size: 24, color: Colors.white),
                    ),
